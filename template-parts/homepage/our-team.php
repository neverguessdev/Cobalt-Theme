    ...
    <div class="section-container">
        ...
        <div class="team-slider-nav">
            ...
            <div class="slider-arrows-container">
                <button aria-label="Prev Slide" class="slider-arrow slider-prev" data-slider-target="teams">
                ...
                <button aria-label="Next Slide" class="slider-arrow slider-next" data-slider-target="teams">
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
