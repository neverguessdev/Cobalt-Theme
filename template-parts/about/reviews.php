        ...
        <div class="about-review-content">
            <div class="ab-review-cards" data-slider="ab-reviews">
                <div class="ab-review-card-container">
                    <div class="ab-review-card">
                        ...
                        <p class="review-text">
                            “Cobalt took the time to understand the values of our organisation. They challenged our thinking
                            and helped us identify what we really needed in this hire.”
                        </p>
                        <div class="reviewer">
                ...
                <div class="ab-review-card-container">
                    <div class="ab-review-card">
                        ...
                        <p class="review-text">
                            “They completely got the brief—and the cultural piece too. It felt like they knew exactly who
                            would click with us from the start.”
                        </p>
                        <div class="reviewer">
                            <img src="/wp-content/uploads/2025/08/ab-reviewer-1.png" alt="Reviewer 1"
                                 class="reviewer-image">
            ...
            <div class="review-slider-nav" data-slider-target="ab-reviews">
                ...
                <div class="slider-arrows-container">
                    <button class="slider-arrow slider-prev" data-slider-target="ab-reviews">
                    ...
                    <button class="slider-arrow slider-next" data-slider-target="ab-reviews">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
